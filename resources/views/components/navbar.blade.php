...
<nav id="mainNav" class="fixed top-0 left-0 right-0 z-50 {{ $alwaysScrolled ? 'scrolled' : '' }}" style="background: transparent;">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 top-full mt-2 w-52 bg-white rounded-2xl shadow-xl border border-gray-100
                            ...
                            @if(auth()->user()->role === 'admin')
                                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:text-pink-600 hover:bg-pink-50 rounded-lg transition">
                            ...
                            @endif
                            <a href="{{ route('booking.index') }}" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:text-pink-600 hover:bg-pink-50 rounded-lg transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                                Pesanan Saya
                            </a>
                            <a href="{{ route('wishlist.index') }}" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:text-pink-600 hover:bg-pink-50 rounded-lg transition">
...
const isAlwaysScrolled = {{ $alwaysScrolled ? 'true' : 'false' }};
